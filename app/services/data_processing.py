...
def get_seasonal_artists(file_path):
    track_data = load_and_preprocess(file_path)
    ...
    artist_seasonal_streams['stream_percentage'] = (artist_seasonal_streams['stream_count'] / artist_seasonal_streams[
        'total_stream_count']) * 100
...
def get_artist_streams(file_path, artist):
    track_data = load_and_preprocess(file_path)
    ...
    artist_monthly_streams['stream_percentage'] = (artist_monthly_streams['stream_count'] / artist_monthly_streams[
        'total_stream_count']) * 100
